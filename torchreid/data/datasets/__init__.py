...
from .image import (
    ...
    Market1501, DukeMTMCreID, University1652, iLIDS, WARD, RPIfield, MiiMSimulation, Sarc3D, PeS3D, MiiMRecorded
)
...
__image_datasets = {
    ...
    'ward': WARD,
    'rpifield': RPIfield,
    'miim_simulation': MiiMSimulation,
    'sarc3d': Sarc3D,
    'pes3d': PeS3D,
    'miim_recorded': MiiMRecorded
}
