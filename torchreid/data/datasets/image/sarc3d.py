...
file_pattern = re.compile("^0*([1-9][0-9]*)-(left|right|front|back|Right)\.bmp")

camera_lookup: dict = {"back": 0, "front": 1, "left": 2, "right": 3, "Right": 4}


class Sarc3D(ImageDataset):
    ...
    dataset_dir = "sarc3d"
    dataset_url = "http://imagelab.ing.unimore.it/sarc3d/ImageLab_ReIdentification_Dataset.zip"
    ...
    def __init__(self, root="", split_id=0, **kwargs):
        ...
        self.crop_path = os.path.join(self.root, "Full Appearance Image")
        ...
        super(Sarc3D, self).__init__(train, query, gallery, **kwargs)
        ...
        if not os.path.exists(self.split_path):
            ...
            for file in os.listdir(crop_path):
                ...
                if match:
                    ...
                    camera_guid = camera_lookup[match.group(2)]
