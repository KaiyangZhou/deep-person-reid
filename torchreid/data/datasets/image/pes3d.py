...
file_pattern = re.compile("^([0-9]+)_([0-9B_]+)_FRAME_[0-9]+_RGB\.bmp")
...
class PeS3D(ImageDataset):
    ...
    dataset_dir = "pes3d"
    dataset_url = "https://drive.google.com/file/d/0B56OfSrVI8hudTZNZmF3dUc0SWc/view?resourcekey=0-lBam9B1J5kbkjxTJcp4N5w"
    ...
    def __init__(self, root="", split_id=0, **kwargs):
        ...
        self.crop_path = os.path.join(self.root, "RGB")
        ...
        super(PeS3D, self).__init__(train, query, gallery, **kwargs)
