...
file_pattern = re.compile("^([0-9]+)_([0-9]+)_[0-9]+\.png")


class RPIfield(ImageDataset):
    ...
    dataset_dir = "rpifield"
    dataset_url = "https://github.com/MZhengRPI/RPIfield"
    ...
    def __init__(self, root="", split_id=0, **kwargs):
        ...
        self.crop_path = os.path.join(self.root, "selected_RPIfield")
        ...
        super(RPIfield, self).__init__(train, query, gallery, **kwargs)
