...
What's new
------------
- [Feb 2021] Add the GPU-Re-Ranking proposed by `Understanding Image Retrieval Re-Ranking: A Graph Neural Network Perspective <https://arxiv.org/abs/2012.07620v2>`_, facilitating the real-time post-processing. The code can be found in `<https://github.com/Xuanmeng-Zhang/gnn-re-ranking>`_.
