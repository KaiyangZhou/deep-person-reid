...
What's new
------------
- [Aug 2022] We have added model export capabilities to the following frameworks: ONNX, OpenVINO and TFLite. The script can be found [here](https://github.com/KaiyangZhou/deep-person-reid/blob/master/tools/export.py)
